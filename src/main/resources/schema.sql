...
CREATE TABLE review (
        ...
        review_image1_alt_text VARCHAR(255) COMMENT '리뷰 이미지 1 alt 텍스트 (SEO 최적화용)',
        review_image2_alt_text VARCHAR(255) COMMENT '리뷰 이미지 2 alt 텍스트 (SEO 최적화용)',
        review_image3_alt_text VARCHAR(255) COMMENT '리뷰 이미지 3 alt 텍스트 (SEO 최적화용)',
