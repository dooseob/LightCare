...
| **팀원 D** | 리뷰/게시판 | 39 SP | 6 SP | **15%** | 일부 프론트엔드 완성 | 백엔드 로직, 게시판 시스템 미구현 |
| **전체** | - | **136 SP** | **42 SP** | **31%** | 프론트엔드 위주 완성 | 백엔드 비즈니스 로직 대부분 미구현 |
...
## 📝 Epic 4: 리뷰 및 게시판 시스템 (팀원 D) - ⚠️ **15% 완료**
...
#### Story 4.2: 리뷰 목록 조회 및 관리 - ❌ **미완료 (0/13 SP)**
- **Story ID**: LC-011
...
#### Story 4.3: 정보 게시판 기능 - ❌ **미완료 (0/13 SP)**
- **Story ID**: LC-012
